        ...
        <div className="flex flex-col items-center">
          ...
          <div className="max-w-3xl mx-auto w-full">
            {formStatus.submitted && formStatus.success ? (
              <div className="bg-gray-50 p-6 md:p-10 rounded-xl text-center" style={aiGradientBorder}>
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={5}
                        className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black resize-none"
                    ...
                    <div>
                      <div style={aiGradientBorder} className="rounded-lg overflow-hidden">
                        <button
                          type="submit"
                          className="w-full bg-white font-medium py-3 px-6 rounded-lg transition-all shadow-md hover:shadow-lg transform hover:-translate-y-1 flex items-center justify-center space-x-2"
                        >
            ...
            <div className="mt-10 md:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 text-center">
              <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                ...
                <a
                  ...
                  className="text-gray-600 hover:text-black text-xs transition-colors break-words"
                >
